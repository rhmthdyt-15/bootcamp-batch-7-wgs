...
function AddPengeluaran() {
    ...
    const handleSubmit = (e) => {
        ...
        axiosJWT
            .post('http://localhost:5000/pengeluaran', formData, Config)
            .then((response) => {
                // Navigasi ke halaman supplier setelah berhasil menambahkan
                navigate('/pengeluaran')

                // Menampilkan pesan sukses
                showSuccessAlert('Pengeluaran Berhasil Ditambahkan!')
    ...
    // Render tampilan komponen AddPengeluaran
    return (
        <div className="bg-white px-4 pt-3 pb-4 rounded-sm border border-gray-200 flex-1">
            <div className="flex justify-between items-center mb-3">
                {/* Judul halaman */}
                <strong className="text-gray-700 font-medium">Tambah Pengeluaran</strong>
            </div>
...
// Mengekspor komponen AddPengeluaran sebagai default
